...
public class EmployeController {
    ...
    public Response<Object> updateEmploye(@Parameter(name = "id", description = "the employe id to updated")
    ...
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public Response<Object> getEmploye(@Parameter(name = "id", description = "the type employe id to valid") @PathVariable Long id) {
        try {
    ...
    @Operation(summary = "Read all employe", description = "It takes input param of the page and returns this list related")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Success"),
            @ApiResponse(responseCode = "500", description = "Internal server error during request processing")})
    @GetMapping("/all")
    @ResponseStatus(HttpStatus.OK)
